...
//Code By : AKRAM .
//Date : 03-03-2022(9h) , 04-03-2022(7h) , 05-03-2022(6h) , 06-03-2022(2h) , 07-03-2022(5h) , 08-03-2022(5h) , 13-03-2022/(10h) .
...
void existing_customer()
{
    ...
    int i,lc,ex=3;
    int cvv,cvv1,dcpin,dcpin1,dc,ec,p=0;
...
//getch();
  ...
  if(dc==1 || c==1 || c==2 || c==3)
  {
    ...
    while(fgets(pline,sizeof(pline),ac_login))
    {
      ...
      //ACCOUNT DETAILS
      else if((c==2 && i>=2 && i<=6) || (i==9 && c==2))
        printf("\t\t\t%s",pline);

      //ACCOUNT BALANCE
      else if((c==1 || dc==1) && i==9)
      {
        printf("\t\t\t%s",pline);
        break;
      }
